...
public abstract class AbstractMaterials {
  ...
  public  AbstractMaterials(Integer id, String materialsBrand, String materialsColor, double priceInUAH, int materialSize, String companyOfManufactures, boolean neededForSockets,
                            String producerName){
    super();
